...
export const ENTITY_METADATA: Record<Loophole_ExtendedEntityType, EntityMetadata> = {
    ...
    CLEANSING_POOL: {
        name: 'Cleansing Pool',
        description: 'A pool that cleanses the player of all pickup status effects.',
        src: 'vector/pool.svg',
        type: 'CLEANSING_POOL',
    ...
    MUSHROOM_BLUE: {
        name: 'Blue Pickup',
        description: 'A pickup that makes the player invisible.',
    ...
    MUSHROOM_GREEN: {
        name: 'Green Pickup',
        description: 'A pickup that makes the player perceive time differently.',
    ...
    MUSHROOM_RED: {
        name: 'Red Pickup',
        description: 'A pickup that lets the player push objects.',
